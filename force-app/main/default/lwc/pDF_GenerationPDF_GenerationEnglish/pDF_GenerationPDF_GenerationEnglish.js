...
import { OMNIDEF } from './pDF_GenerationPDF_GenerationEnglish_def.js';
import tmpl from './pDF_GenerationPDF_GenerationEnglish.html';
import tmpl_nds from './pDF_GenerationPDF_GenerationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pDF_GenerationPDF_GenerationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
