...
import { OMNIDEF } from './oS_HandsOnOS_HandsOnEnglish_def.js';
import tmpl from './oS_HandsOnOS_HandsOnEnglish.html';
import tmpl_nds from './oS_HandsOnOS_HandsOnEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class oS_HandsOnOS_HandsOnEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
