...
import { OMNIDEF } from './lWCwithOSLWCwithOSEnglish_def.js';
import tmpl from './lWCwithOSLWCwithOSEnglish.html';
import tmpl_nds from './lWCwithOSLWCwithOSEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lWCwithOSLWCwithOSEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
