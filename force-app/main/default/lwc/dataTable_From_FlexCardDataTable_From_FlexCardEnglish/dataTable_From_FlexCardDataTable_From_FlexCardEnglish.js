...
import { OMNIDEF } from './dataTable_From_FlexCardDataTable_From_FlexCardEnglish_def.js';
import tmpl from './dataTable_From_FlexCardDataTable_From_FlexCardEnglish.html';
import tmpl_nds from './dataTable_From_FlexCardDataTable_From_FlexCardEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dataTable_From_FlexCardDataTable_From_FlexCardEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
